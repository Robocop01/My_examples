...
&p21,&p22,&p23,&p24,&p25,&p26,&p27,&p28,&p29,&p30,&p31,&p32); bb=0;
   ...
   for (i=1; i<=ii; i++)
if (     //1_
        ap1[i]==p1 && ap6[i]==p6 && ap2[i]==p2 && ap3[i]==p3 && ap4[i]==p4 && ap5[i]==p5)
...
if (ii==10000 || ii==50000
 || ii==100000 || ii==200000
   || ii==300000 || ii==400000
    || ii==500000 || ii==600000
     || ii==700000 || ii==800000
      || ii==900000 || ii==1000000
       || ii==1100000 || ii==1150000
              || ii==1200000 || ii==1250000) std::cout << "№ = " << i << "№ = " << w << std::endl;
}
}                         //**
